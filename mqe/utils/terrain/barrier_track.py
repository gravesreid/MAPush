...
class BarrierTrack:
    ...
    track_kwargs = dict(
            ...
            static_friction = 1.0, # friction coefficient
            dynamic_friction = 1.0, # friction coefficient
        )
    ...
    def __init__(self, cfg, num_envs: int, num_agents=1) -> None:
        ...
        self.cfg.static_friction =  self.track_kwargs['static_friction']
        self.cfg.dynamic_friction = self.track_kwargs['dynamic_friction']
    ...
    def add_terrain_to_sim(self, gym, sim, device= "cpu"):
        ...
        for col_idx in range(self.cfg.num_cols):
            ...
            for row_idx in range(self.cfg.num_rows):
                ...
                self.agent_origins[row_idx, col_idx, :, :2] = ( env_origin[:, :2]) * self.cfg.horizontal_scale
                self.agent_origins[row_idx, col_idx, :, 2] = ( env_origin[:, 2]) * self.cfg.vertical_scale
