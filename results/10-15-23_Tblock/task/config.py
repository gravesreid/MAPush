...
class Go1PushCfg(Go1Cfg):
    ...
    class termination(Go1Cfg.termination):
        ...
        collision_kwargs = dict(threshold= 0.27)
        termination_terms = [
            "roll",
            "pitch",
            "z_wave",
    ...
    class rewards(Go1Cfg.rewards):
        expanded_ocb_reward = True
        class scales:
            target_reward_scale = 60
            approach_reward_scale = 15
            collision_punishment_scale = -40
            push_reward_scale = 30
            ocb_reward_scale = 80
            reach_target_reward_scale = 200000
            exception_punishment_scale = -100000
    ...
    class init_state(Go1Cfg.init_state):
        ...
        init_states_npc = [
            # physical box 
            init_state_class(
                pos = [12.0, 0.0, 0.30],                                          # box_pos_origin
                rot = [0.0, 0.0, 0.0, 1.0],
